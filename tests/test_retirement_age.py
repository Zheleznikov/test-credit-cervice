...
def test_tc_0211_retirement_age_should_be_approved(bench, body):
...
def test_tc_0212_retirement_age_should_be_denied(bench, body):
    res = send_rq_to_check_about_credit_info(bench, check_info, body)
...
def test_tc_0213_retirement_age_should_be_approved(bench, body):
    res = send_rq_to_check_about_credit_info(bench, check_info, body)
    credit_should_be_approved(res)
    year_payment_should_exist(res)
...
def test_tc_0214_retirement_age_should_be_denied(bench, body):
    res = send_rq_to_check_about_credit_info(bench, check_info, body)
    credit_should_be_denied(res)
    year_payment_should_absent(res)
